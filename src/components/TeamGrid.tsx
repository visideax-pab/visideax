    ...
    <>
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {team.map((member, i) => (
          ...
          >
            <TiltCard className="h-full border border-alpine-slate/10 bg-white/60 transition-colors hover:border-alpine-gold/40">
              <button
                onClick={() => setActive(member)}
                className="flex h-full w-full flex-col items-start p-9 text-left"
              >
                ...
                <p className="mt-5 text-sm leading-relaxed text-alpine-slate/60 line-clamp-3">
                  {member.bio}
                </p>
